      ...
      <div className="mb-4">
        <div className="flex gap-2">
          <input
            ...
            aria-label="What would you like to know about your genome?"
            placeholder="What would you like to know about your genome?"
            disabled={loading}
            className="flex-1 px-4 py-3 text-sm border border-border rounded-sm bg-surface text-text placeholder:text-text-muted focus:outline-none focus:border-accent focus-visible:ring-2 focus-visible:ring-accent font-mono disabled:opacity-50 transition-colors"
          />
          <button
            onClick={() => handleSubmit()}
            disabled={loading || !query.trim()}
            aria-label="Submit query"
            className="px-5 py-3 text-sm border border-border rounded-sm text-text-muted hover:text-text hover:border-accent disabled:opacity-30 transition-colors duration-100 shrink-0 focus-visible:ring-2 focus-visible:ring-accent focus-visible:outline-none"
          >
            {loading ? '...' : 'Ask'}
          </button>
        </div>

    ...
    <div className="flex h-screen">
          ...
          {!claudeApiKey && (
            <div className="px-3 py-2 border-t border-border">
              <div className="flex gap-1">
                ...
                <button onClick={handleSaveApiKey} disabled={!apiKeyInput.trim()} aria-label="Save API key" title="Save API key" className="px-1.5 py-1 text-[9px] border border-border rounded-sm text-text-muted hover:text-accent disabled:opacity-30 transition-colors shrink-0">OK</button>
              </div>
            </div>
          )}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="border-t border-border px-4 py-2.5 flex items-center gap-2 shrink-0">
          ...
          <button onClick={handleSubmit} disabled={loading || streaming || !query.trim()} aria-label="Submit question" title="Submit question"

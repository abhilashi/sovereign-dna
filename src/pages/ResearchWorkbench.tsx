          ...
          {!claudeApiKey && (
            <div className="px-3 py-2 border-t border-border">
              <div className="flex gap-1">
                ...
                <button aria-label="OK - Save API Key" onClick={handleSaveApiKey} disabled={!apiKeyInput.trim()} className="px-1.5 py-1 text-[9px] border border-border rounded-sm text-text-muted hover:text-accent disabled:opacity-30 transition-colors shrink-0">OK</button>
              </div>
            </div>
          )}
